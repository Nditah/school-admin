...
import { FeeEditComponent } from 'src/app/pages/fee/fee-edit/fee-edit.component';
import { FeeDetailComponent } from 'src/app/pages/fee/fee-detail/fee-detail.component';
