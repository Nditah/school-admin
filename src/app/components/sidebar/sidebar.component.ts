...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/account-class',         title: 'Account Class',               icon: 'users_single-02',                class: '', sub: null },
    ...
    { path: '/student',               title: 'Student',                     icon: 'users_circle-08',                class: '', sub: null },
    ...
    { path: '/payroll',               title: 'Payroll',                      icon: 'business_bank',                  class: '', sub: null },
    { path: '/expense',               title: 'Expenses',                    icon: 'business_bank',                  class: '', sub: null },
    ...
    { path: '/asset',                 title: 'Asset',                       icon: 'users_single-02',                 class: '', sub: null },
    { path: '/report',                title: 'Report',                      icon: 'business_bank',                 class: '',  sub: null },
